    ...
    return (
      <div className="bg-gray-900 text-white min-h-screen font-sans flex items-center justify-center px-4">
        <div className="text-center max-w-md mx-auto">
          ...
          <Link
            to="/#projects"
            className="inline-flex items-center gap-2 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl"
          >
    ...
    <div className="bg-gray-900 text-white min-h-screen font-sans">
      <header className="fixed top-0 w-full bg-gray-950/80 backdrop-blur-md shadow-md z-50">
        ...
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <Link
            to="/#projects"
            className="inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-purple-500 text-white px-4 py-2.5 sm:px-5 sm:py-3 rounded-lg sm:rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg font-medium text-sm sm:text-base shadow-md"
          >
            <FontAwesomeIcon icon={faArrowLeft} className="text-sm" />
            <span>Back to Projects</span>
          </Link>

          <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-white truncate max-w-[200px] sm:max-w-none ml-2 sm:ml-4">
            {project.title}
          </h1>
        </nav>
      </header>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 sm:pb-12 lg:pb-16 pt-16 sm:pt-20 lg:pt-24">
        ...
        <div className="mb-6 sm:mb-8 lg:mb-10">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 sm:mb-6">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">
              {project.title}
            </h1>
            ...
            <div className="sm:hidden">
              <Link
                to="/#projects"
                className="inline-flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 hover:border-purple-500 text-white w-full px-4 py-3 rounded-lg transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-lg font-medium text-sm shadow-md"
              >
                <FontAwesomeIcon icon={faArrowLeft} className="text-sm" />
                <span>Back to Projects</span>
              </Link>
          ...
          <div className="lg:w-1/3 space-y-6 sm:space-y-8">
            ...
            <div className="bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 space-y-3 sm:space-y-4">
              ...
              <div className="hidden sm:block pt-2">
                <Link
                  to="/#projects"
                  className="w-full flex items-center justify-center gap-2 sm:gap-3 px-4 py-3 sm:px-6 sm:py-4 bg-gray-700 hover:bg-gray-600 border border-gray-600 hover:border-purple-500 text-white rounded-lg sm:rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg font-semibold text-sm sm:text-base shadow-md"
                >
                  <FontAwesomeIcon icon={faArrowLeft} />
                  Back to Projects
                </Link>
